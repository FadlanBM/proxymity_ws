...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('right_linear_y', default_value='-0.05',
                              description='Legacy: Linear y speed when moving right'),
        DeclareLaunchArgument('backward_linear_x', default_value='0.02',
                              description='Legacy: Linear x speed when moving backward'),
        DeclareLaunchArgument('backward_duration', default_value='1.5',
                              description='Legacy: Duration in seconds to send backward command'),
